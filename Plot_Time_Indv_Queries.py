...
df_bindex = pd.read_csv(r"C:\Users\spachava\Downloads\INRAE_M2_Stage_Work_April_August_2024\4GB Files\Workload2\exe_times_WL2_BIndex_4GB.csv", encoding='utf-8').iloc[:-2]
df_aindex = pd.read_csv(r"C:\Users\spachava\Downloads\INRAE_M2_Stage_Work_April_August_2024\4GB Files\Workload2\exe_times_WL2_AIndex_4GBfloat.csv", encoding='utf-8').iloc[:-2]
